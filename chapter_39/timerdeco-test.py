...
for func in (listcomp, mapcall):
    ...
    func(500000)                                                    # Time for this call, all calls
    print(result)                                                   # Print this value on exit
    print('all timings:', func.alltime)                       # Print all call timings on exit
...
class Person:
    ...
    @timer(label='**')
    def lastName(self):                                                 # Redefine lastName = timer(...)(lastName)
