...
def total(func, *pargs, **kargs):
    _reps = kargs.pop('_reps', 100)                                         # Passed-in or default reps
...
'''
It uses dictionary pop operations to remove the
argument from arguments intended for the 
_reps test function and provide it with a default
'''
